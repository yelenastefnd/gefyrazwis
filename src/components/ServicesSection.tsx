...
import { Droplets, Heart, Baby, Bone, ChevronDown, ChevronUp, Info, HeartHandshake } from "lucide-react";
...
const ServicesSection = () => {
  ...
  const services: ServiceTab[] = [
    ...
    },
    {
      ...
      icon: HeartHandshake,
      title: "Δωρεά Οργάνων",
      subtitle: "Έκδοση κάρτας δωρητή",
      content: {
        intro: "Η μεταμόσχευση είναι μία εγχείρηση κατά την οποία υγιή όργανα, ιστοί ή κύτταρα μεταφέρονται από ένα νεκρό ή ζωντανό δότη σε έναν χρονίως πάσχοντα άνθρωπο με σκοπό την αποκατάσταση της λειτουργίας των οργάνων του.",
        sections: [
          {
            question: "Πώς εκδίδω κάρτα δωρητή οργάνων; (eom.gr)",
            answer: [
              "1. Μπες στο eom.gr και πάτα το κουτάκι «ΕΘΝΙΚΟ ΜΗΤΡΩΟ ΔΩΡΕΑΣ ΟΡΓΑΝΩΝ ΚΑΙ ΙΣΤΩΝ» - Γίνε Δωρητής",
              "2. Στο νέο παράθυρο πάτα «ΝΑ ΕΓΓΡΑΦΩ ΣΤΟ ΜΗΤΡΩΟ ΔΩΡΗΤΩΝ»",
              "3. Επέλεξε «ΕΠΙΘΥΜΩ ΝΑ ΓΙΝΩ ΔΩΡΗΤΗΣ ΟΡΓΑΝΩΝ ΚΑΙ ΙΣΤΩΝ»",
              "4. Κάνε Είσοδο με TAXIS NET (κωδικοί εφορίας: όνομα χρήστη & κωδικό)",
              "5. Πάτα Αποστολή και βάλε το ΑΜΚΑ σου",
              "6. Επιβεβαίωση στοιχείων (γράψε διεύθυνση & στοιχεία επικοινωνίας)",
              "7. Τσεκάρισε ότι συμφωνείς με τους όρους και πάτα Καταχώρηση"
            ]
          },
          {
            question: "Ποιά είναι η διαδικασία της μεταμόσχευσης;",
            answer: [
              "Πολλά νοσήματα μπορούν να καταστρέψουν τα όργανά μας και πολλές φορές χρειάζεται αυτά να αντικατασταθούν για να συνεχίσουμε να ζούμε.",
              "Όταν κάποιος ασθενής διαγνωσθεί πως χρειάζεται μεταμόσχευση κάποιου οργάνου, εγγράφεται σε μια λίστα αναμονής.",
              "Όταν υπάρχει πτωματικός δότης επιλέγεται από τη λίστα ο καταλληλότερος υποψήφιος λήπτης.",
              "Η επιλογή του λήπτη γίνεται βάσει μορίων: ομάδα αίματος, ηλικία, ιστοσυμβατότητα, χρόνος αναμονής και εγγύτητα του τόπου.",
              "Η διαδικασία της επιλογής είναι αδιάβλητη και εξαρτάται από ιατρικά κριτήρια."
            ]
          },
          {
            question: "Τι γίνεται όταν βρεθεί κατάλληλος λήπτης;",
            answer: [
              "Ο ασθενής που επιλέγεται ειδοποιείται και έρχεται στο νοσοκομείο.",
              "Κρίνεται αν τη δεδομένη στιγμή είναι σε κατάσταση που μπορεί να μεταμοσχευθεί.",
              "Εάν κριθεί ακατάλληλος, το μόσχευμα προσφέρεται στον επόμενο κατάλληλο ασθενή στη λίστα.",
              "Όταν πιστοποιηθεί η καταλληλότητα, ξεκινάει η προετοιμασία για τη μεταμόσχευση.",
              "Ταυτόχρονα ξεκινάει η εγχείρηση ανάκτησης των οργάνων από τον δότη."
            ]
          },
          {
            question: "Πώς μπορεί κάποιος να γίνει Δωρητής Ιστών και Οργάνων;",
            answer: [
              "Κάθε άνθρωπος οποιασδήποτε ηλικίας μπορεί να γίνει μετά θάνατον Δωρητής Οργάνων.",
              "Αποστέλλοντας στον Εθνικό Οργανισμό Μεταμοσχεύσεων τη «δήλωση δωρεάς οργάνων».",
              "ΣΗΜΑΝΤΙΚΟ: Ενημερώστε την οικογένειά σας για αυτή την απόφαση.",
              "Σε ιδιαίτερες περιπτώσεις μπορεί να δοθεί από ζώντα δότη ένα νεφρό σε συγγενή δευτέρου βαθμού (Νόμος 2737/99).",
              "Επίσης μπορεί να μεταμοσχευτεί μέρος του ήπατος, πνεύμονα, λεπτού εντέρου και αιμοποιητικά κύτταρα."
            ]
          },
          {
            question: "Ποιοι περιορισμοί υπάρχουν στη δωρεά από ζώντα δότη;",
            answer: [
              "Η αφαίρεση ιστών και οργάνων από ζώντα δότη επιτρέπεται μόνον για μεταμόσχευση σε σύζυγο ή συγγενή μέχρι δεύτερο βαθμό εξ αίματος.",
              "Ο περιορισμός αυτός ΔΕΝ ισχύει στη μεταμόσχευση αιμοποιητικών κυττάρων (μυελού των οστών).",
              "Ο άνθρωπος μπορεί να ζήσει φυσιολογικά και με ένα μόνο νεφρό."
            ]
          }
        ]
      }
