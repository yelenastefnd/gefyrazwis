...
const EventsSection = () => {
  const upcomingEvents: Event[] = [{
    ...
    time: "15:30 – 19:30",
    location: "Πνευματικό Κέντρο Άνω Κώμης",
    ...
    id: 3,
    title: "34η ΑΙΜΟΔΟΣΙΑ στο AEI (Φλώρινα)",
    ...
    description: "Την Πέμπτη 27 Νοεμβρίου 2025, από τις 09:00 έως 13:00, πραγματοποιείται εθελοντική αιμοδοσία στο Εργαστήριο Φυσικών Επιστημών της Σχολής Κοινωνικών και Ανθρωπιστικών Επιστημών του Πανεπιστημίου Δυτικής Μακεδονίας στη Φλώρινα.\nΗ δράση υλοποιείται με το Τμήμα Αιμοδοσίας του Γ.Ν. Φλώρινας \"Ελένη Δημητρίου\", σε συνεργασία με την Ολιστική Μέριμνα και το Πανεπιστήμιο Δυτικής Μακεδονίας, στα πλαίσια του μνημονίου συνεργασίας μας.\nΗ συμμετοχή των φοιτητών και της ακαδημαϊκής κοινότητας δίνει δύναμη σε όσους παλεύουν για τη ζωή. Κάθε προσφορά γίνεται ελπίδα! Κάθε εθελοντής ένας κρίκος στην αλυσίδα ανθρωπιάς!\nΠαράλληλα, τα μέλη του Συλλόγου θα πραγματοποιούν ενημέρωση και λήψη δείγματος σάλιου για δωρεά μυελού των οστών.\n\nΑπαραίτητες προϋποθέσεις κατά την προσέλευση στην αιμοδοσία του υποψήφιου Εθελοντή αιμοδότη για προσφορά αίματος είναι:\n1.Να αισθάνεστε καλά\n2.Να είστε ξεκούραστοι\n3.Να έχετε κοιμηθεί την προηγούμενη ημέρα 6-7 ώρες τουλάχιστον.\n\nΝα υπενθυμίσουμε ότι:\nΤρώμε ένα ελαφρύ γεύμα 3 ώρες πριν\nΔεν πίνουμε αλκοόλ την προηγούμενη ημέρα\nΔεν έχουμε πάρει ασπιρίνες την τελευταία εβδομάδα\nΔηλώνουμε στο Γιατρό αιμοδοσίας ποια φάρμακα παίρνουμε.\nΕΧΟΥΜΕ μαζί τον Αριθμό ΑΜΚΑ ή Ταυτότητας.\nΔΩΣΕ ΑΙΜΑ- ΧΑΡΙΣΕ ΖΩΗ\n\nΜε σεβασμό στους Ασθενείς και εκτίμηση στους Εθελοντές Αιμοδότες."
  }];
